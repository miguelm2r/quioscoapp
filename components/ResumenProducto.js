  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
        ...
        <div className="">
            <button
                type="button"
                className="bg-sky-700 flex px-5 py-2 text-white font-bold uppercase
                 rounded-md shadow-md w-full gap-2"
            ...
            <button
                type="button"
                className="bg-red-700 flex px-5 py-2 text-white font-bold uppercase
                 rounded-md shadow-md w-full mt-3 gap-2"
