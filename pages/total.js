    ...
    <Layout pagina='Total y Confirmar Pedido'>
        ...
        >
          <div>
            ...
            >
              ...
              <input
                id="nombre"
                type="text"
                className="bg-gray-200 w-full lg:w-1/3 p-2 mt-3 rounded"
                value={nombre}
          ...
          <div className="mt-5">
            <input 
              type="submit"
              className={`${comprobarPedido() ? 'bg-indigo-100' : 'bg-indigo-600 hover:bg-indigo-800 hover:cursor-pointer'} w-full lg:w-auto px-5 py-2 
